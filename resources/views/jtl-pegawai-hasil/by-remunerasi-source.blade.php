@extends('root')
@section('title', 'Data JTL Pegawai Hasil - {{ $remunerasiSource->nama }}')

@section('content')
<div class="container-fluid">
    @include('components.breadcrumb', [
        'title' => 'Data JTL Pegawai Hasil - ' . $remunerasiSource->nama,
        'links' => [
            ['url' => route('dashboard'), 'label' => 'Dashboard'],
            ['url' => route('jtl-pegawai-hasil.index'), 'label' => 'JTL Pegawai Hasil'],
        ],
        'current' => $remunerasiSource->nama
    ])
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah JTL Pegawai Hasil - {{ $remunerasiSource->nama }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form id="createForm" method="POST" action="{{ route('jtl-pegawai-hasil.store') }}">
                @csrf
                <input type="hidden" name="remunerasi_source" value="{{ $remunerasiSourceId }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $remunerasiSource->nama }}" readonly>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="editModal" tabindex="-1">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit JTL Pegawai Hasil - {{ $remunerasiSource->nama }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
...
$(document).ready(function() {
    ...
    $('#btn-export').on('click', function() {
        ...
        var params = ['remunerasi_source_id={{ $remunerasiSourceId }}'];
