...
@section('title', 'Kategori Indeks Jasa Tidak Langsung')

@section('content')
<div class="container-fluid">
    @include('components.breadcrumb', [
        'title' => 'Kategori Indeks Jasa Tidak Langsung',
        'links' => [
            ['url' => route('dashboard'), 'label' => 'Dashboard'],
        ],
        'current' => 'Kategori Indeks Jasa Tidak Langsung'
    ])
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Kategori Indeks Jasa Tidak Langsung</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form id="createForm" method="POST" action="{{ route('kategori-tidak-langsung.store') }}">
                @csrf
...
<div class="modal fade" id="editModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Kategori Indeks Jasa Tidak Langsung</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
