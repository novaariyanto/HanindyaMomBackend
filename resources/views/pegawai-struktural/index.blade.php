@extends('root')
@section('title', 'Pegawai Struktural')

@section('content')
<div class="container-fluid">
    @include('components.breadcrumb', [
        'title' => 'Pegawai Struktural',
        'links' => [
            ['url' => route('dashboard'), 'label' => 'Dashboard'],
        ],
        'current' => 'Pegawai Struktural'
    ])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-light">
                    <h5 class="card-title mb-0">Data Pegawai Struktural</h5>
                </div>
                <div class="card-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Pegawai Struktural</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form id="createForm" method="POST" action="{{ route('pegawai-struktural.store') }}">
                @csrf
...
<div class="modal fade" id="editModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Pegawai Struktural</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
...
$(document).ready(function() {
    var datatable = $('#datatable').DataTable({
        ...
        autoWidth: false,
        ajax: {
            url: '{{ route('pegawai-struktural.index') }}',
        },
        columns: [
            {
                data: 'DT_RowIndex',
