...
<div class="modal fade" id="createModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="createForm" method="POST" action="{{ route('transaksi-remunerasi.store') }}">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Total Remunerasi</label>
                        <input type="number" step="0.01" class="form-control" name="total_remunerasi" required min="0">
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <form id="editForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Periode</label>
                        <input type="month" class="form-control" name="periode" id="edit_periode" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Total Remunerasi</label>
                        <input type="number" step="0.01" class="form-control" name="total_remunerasi" id="edit_total_remunerasi" required min="0">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Status</label>
...
<div class="modal fade" id="importModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="importForm" action="{{ route('transaksi-remunerasi.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <a href="{{ route('transaksi-remunerasi.template') }}" class="btn btn-sm btn-info">
...
$(document).ready(function() {
    var datatable = $('#datatable').DataTable({
        ...
        autoWidth: false,
        ajax: {
            url: '{{ route('transaksi-remunerasi.index') }}',
        },
        columns: [
            {
                data: 'DT_RowIndex',
            ...
            {
                data: 'total_remunerasi',
                name: 'total_remunerasi',
                render: function(data) {
    ...
    $(document).on('click', '.btn-edit', function() {
        ...
        $.get(url, function(response) {
            if (response.meta.status === 'success') {
                ...
                $('#edit_total_remunerasi').val(data.total_remunerasi);
...
function startBatchSync() {
    ...
    // Ambil total records
    $.ajax({
        url: '/transaksi-remunerasi/get-unsynced-count',
        type: 'GET',
        success: function(response) {
    ...
    function processBatch(offset) {
        $.ajax({
            url: '/transaksi-remunerasi/sync-batch',
            type: 'POST',
            data: {
                offset: offset,
                limit: 5
