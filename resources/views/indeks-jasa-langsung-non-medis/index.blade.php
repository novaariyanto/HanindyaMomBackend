...
@section('title', 'Indeks Jasa Langsung Non Medis')

@section('content')
<div class="container-fluid">
    @include('components.breadcrumb', [
        'title' => 'Indeks Jasa Langsung Non Medis',
        'links' => [
            ['url' => route('dashboard'), 'label' => 'Dashboard'],
        ],
        'current' => 'Indeks Jasa Langsung Non Medis'
    ])
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                    <button type="button" class="btn btn-primary d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#createModal">
                        <i class="ti ti-plus text-white me-1 fs-5"></i> Tambah Indeks Jasa Langsung Non Medis
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Indeks Jasa Langsung Non Medis</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form id="createForm" method="POST" action="{{ route('indeks-jasa-langsung-non-medis.store') }}">
                @csrf
...
<div class="modal fade" id="editModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Indeks Jasa Langsung Non Medis</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
...
$(document).ready(function() {
    ...
    var datatable = $('#datatable').DataTable({
        ...
        autoWidth: false,
        ajax: {
            url: '{{ route('indeks-jasa-langsung-non-medis.index') }}',
        },
        columns: [
            {
                data: 'DT_RowIndex',
