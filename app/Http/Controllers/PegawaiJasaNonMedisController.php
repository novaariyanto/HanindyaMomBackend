...
class PegawaiJasaNonMedisController extends Controller
{
    public function index()
    {
        if (request()->ajax()) {
            $data = PegawaiJasaNonMedis::with(['pegawai', 'jasa']);
        ...
        $jasa = IndeksJasaLangsungNonMedis::all();
        
        return view('pegawai-jasa-non-medis.index', compact('pegawai', 'jasa'));
    }
    ...
    public function create()
    {
        ...
        return view('pegawai-jasa-non-medis.create', compact('pegawai', 'jasa'));
    }
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'jasa_id' => 'required|exists:indeks_jasa_langsung_non_medis,id',
        ...
        try {
            $pegawaiJasa = PegawaiJasaNonMedis::create($request->all());
            return response()->json([
                'meta' => [
                    'code' => 200,
    ...
    {
        try {
            $data = PegawaiJasaNonMedis::with(['pegawai', 'jasa'])->findOrFail($id);
            return response()->json([
                'meta' => [
                    'code' => 200,
    ...
    {
        try {
            $pegawaiJasa = PegawaiJasaNonMedis::findOrFail($id);
    ...
    {
        try {
            $pegawaiJasa = PegawaiJasaNonMedis::withTrashed()->findOrFail($id);
            $pegawaiJasa->restore();
